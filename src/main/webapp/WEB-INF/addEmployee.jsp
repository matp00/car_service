...
<form method="post" target="/addEmployee">
    <h1>Add Employee</h1>
    <div class="form-row">
    ...
    <div class="form-row">
        ...
        <div class="form-group">
            <input type="number" class="form-control" placeholder="Hourly" name="hourly">
        </div>
        <div class="col">
    ...
    <div class="form-row">
        ...
        <div class="form-group">
            <input type="number" class="form-control" placeholder="Day" name="day">
        </div>
    </div>
