...
<form method="post" target="/editOrder">
    <div class="form-row">
        <div class="form-group col-md-6">
            <input type="number" class="form-control" placeholder="Status id" name="status_id" value="${order.status_id}">
        </div>
        <div class="form-group col-md-6">
            <input type="number" class="form-control" placeholder="Vehicle id" name="vehicle_id" value="${order.vehicle_id}">
        </div>
    </div>
    <div class="form-row">
        <div class="col">
            <input type="text" class="form-control" placeholder="Problem description" name="problem_description" value="${order.problem_description}">
        </div>
    </div>
    <br>
    <div class="form-row">
    ...
    <div class="form-row">
        <div class="form-group col-md-2">
            <input type="number" class="form-control" placeholder="Employee id" name="employee_id" value="${order.employee_id}">
        </div>
        <div class="form-group col-md-2">
            <input type="text" class="form-control" placeholder="Total price" name="total_price" value="${order.total_price}">
        </div>
        <div class="form-group col-md-2">
            <input type="text" class="form-control" placeholder="Parts cost" name="parts_cost" value="${order.parts_cost}">
        </div> <div class="form-group col-md-2">
        <input type="text" class="form-control" placeholder="Hours amount" name="hours_amount" value="${order.hours_amount}">
    </div>
    </div>
    <div class="form-row">
        <div class="col">
            <input type="text" class="form-control" placeholder="Maintenance description" name="maintenance_description" value="${order.maintenance_description}">
        </div>
    </div>
    <br>
